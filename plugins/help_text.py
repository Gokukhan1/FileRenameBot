    ...
    if update_channel:
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('Support Channel', url='https://t.me/Zyro_Anime'),
                    InlineKeyboardButton('Feedback', url='https://t.me/PiratesBotRepo')
                ],
                [
                    InlineKeyboardButton('Other Bots', url='https://t.me/ABOUT_XENO/9'),
                    InlineKeyboardButton('Source', url='https://github.com/Gokukhan1/FileRenameBot')
                ]
            ]
        ),
